...
/**
 * Servlet implementation class EditWelcomeServlet
 */
public class EditWelcomeServlet extends HttpServlet {
	...
	protected void process(HttpServletRequest request,
		...
		try {
			...
			if (errMsgs.size() == 0) {
				returnJson = WelcomeCtl.editWelcome(inputJson);
			} else {
