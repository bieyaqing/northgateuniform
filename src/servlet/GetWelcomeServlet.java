...
/**
 * @author bieyaqing
 * Servlet implementation class GetWelcomeServlet
 */
public class GetWelcomeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetWelcomeServlet() {
		super();
	...
	protected void process(HttpServletRequest request,
		...
		try {
			...
			if (errMsgs.size() == 0) {
				returnJson = WelcomeCtl.getWelcome(inputJson);
			} else {
