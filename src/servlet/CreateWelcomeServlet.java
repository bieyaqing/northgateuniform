...
/**
 * @author bieyaqing Servlet implementation class CreateWelcomeServlet
 */
public class CreateWelcomeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CreateWelcomeServlet() {
		super();
	...
	protected void process(HttpServletRequest request,
		...
		try {
			...
			JSONObject inputJson = (JSONObject) Config.JPARSER
					.parse(inputJsonStr);
			System.out.println(Config.SHOWINPUT + inputJson.toJSONString());

			if (errMsgs.size() == 0) {
				returnJson = WelcomeCtl.createWelcome(inputJson);
			} else {
